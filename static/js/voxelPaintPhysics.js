...
var UNIQUE_ID =  randomString(6, '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ');
			...
			function init() {
				...
				info.innerHTML = '<a href="http://threejs.org" target="_blank">three.js</a> - voxel painter - <a href="<a href="http://threejs.org" target="_blank">ammo.js</a> - physics - webgl<br><strong>press SPACEBAR</strong>: add voxel, <strong>shift + click</strong>: remove voxel <br>MOVE mouse &amp; press LEFT/A: rotate, MIDDLE/S: zoom, RIGHT/D: pan<br>block Color changes: press, r:red g:green b:blue';
